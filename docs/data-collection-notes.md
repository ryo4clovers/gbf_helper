...
- 主人公通常攻撃21hit（21,103〜22,852）は、表示通常予測21,868を含め、既存式`ceil(20,513.64161496 × 乱数 × 1.066)`と0.001刻み乱数で21/21件一致した。
...
- 保留: 武器を追加して39,028.434超の減衰開始点・各通過率を探索、ブレイク中とOD中の実ダメージ、途中・最終丸め順の交差検証。
