...
- 闇属性SR: scratch-build-list.mjsでリスト取得35体。GameWith全35体のページ取得完了、gbf.wiki検索は25/35体で候補あり(curl経由で取得)。dossier生成完了(batch_000-007.txt〜batch_032-034.txt)。次はindex0から処理開始。
