...
- 火属性R: scratch-build-list.mjsでリスト取得18体。GameWith全18体のページ取得完了、gbf.wiki検索は17/18体で候補あり(curl経由で取得)。dossier生成完了(batch_000-007.txt〜batch_016-017.txt)。次はindex0から処理開始。
