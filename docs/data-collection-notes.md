...
- 風属性SR: scratch-build-list.mjsでリスト取得49体。GameWith全49体のページ取得完了、gbf.wiki検索は34/49体で候補あり(curl経由で取得)。dossier生成完了(batch_000-007.txt〜batch_048-048.txt)。次はindex0から処理開始。
