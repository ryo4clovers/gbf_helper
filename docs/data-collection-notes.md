...
- 主人公の最終連撃率は、ナイト基礎DA 7%/TA 3% + コンプリートDA 7%/TA 5% + 武器スキルDA 32.9%/TA 32.9% = **DA 46.9% / TA 40.9%**となるモデルを回帰テスト化した。
...
- 保留: 実戦の攻撃回数からDA 46.9% / TA 40.9%を統計的に確認すること、通常連撃武器スキル枠の75%上限、表示丸めの境界値、神滅の印章の実戦時連撃寄与。
