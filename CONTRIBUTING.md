...
- ローカル計算機の主人公を右クリックするか「強化設定」を押すと、ジョブLv・ML・極致・攻撃力LB・HP LB・味方全体HP LB全3項目・クリティカルLB全3項目・得意武器攻撃LB全8項目・連撃系LB全5項目・現在の主人公属性に対応する属性攻撃LB（無印・II・III）を入力できます。非対応のML・極致は無効表示です。
