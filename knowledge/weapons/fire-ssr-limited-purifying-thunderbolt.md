...
source: "本家武器一覧から通常表示した装備詳細レスポンス(2026-09-21確認) / gbf.wiki Cargo weaponsテーブル(r.jina.ai経由、2026-09-09取得) / GameWith https://xn--bck3aza1a2if6kra4ee0hf.gamewith.jp/article/show/136479 (2026-09-21参照)。skill_idは実機確認済み、効果量は要検証。"
---
...
通常必殺と通常技巧を持つ火属性リミテッド弓。本家武器一覧から通常表示した装備詳細レスポンスで、武器ID・スキル構成・効果文・skill_idを確認済み。記載した効果量は要検証。
...
- `skillSlots`は未接続。skill_idは確認済みだが、必殺と技巧の効果量・加護後端数を実機検証してから接続する。

## 未確認・要検証事項

- 必殺・技巧の加護後端数、覚醒効果、奥義の数値と継続ターン。
