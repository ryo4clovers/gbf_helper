...
| シリーズ | `series_id` | 付与枠 | 備考 |
| --- | --- | --- | --- |
| マグナシリーズ(旧マグナ / マグナ1) | 8 | 第2スキル | 付与率 約60%(サンプル調査値)。レプリカルド・サンドボックス等でExスキル付きがドロップ |
| アンセスタルシリーズ(六竜武器) | 未確認 | 第2スキル以降 | |
| プライマルシリーズ | 未確認 | 第2スキル以降 | |
| オールドプライマルシリーズ | 未確認 | 第2スキル以降 | |

※ レガリアシリーズ(`series_id` 7)・マグナ・リバースシリーズ(`series_id` 42)の第2スキル以降は**武器固有スキル**であり Exスキルではない(個体差なし)。

### 仕様

- **抽選**: ドロップ時に固定。第1スキル(武器固有)は変わらず、Exスキル枠のみランダム。効果は1〜2個。
- **効果量**: スキルレベルによる上昇は無く、入手時の効果量で固定。
- **継承**: 武器強化画面の「レベル継承」で、同名武器へ Exスキルを移植できる。
- **枠(frame)**: 効果ごとに異なる。攻撃力UP は久遠枠(要検証)、渾身・背水は LB / ストレングス / 逆境枠などに乗るとされる(要検証)。

### 抽選プール(実データ + 二次情報、要検証)

第1スキルの系統ごとに抽選候補が絞られる模様(tkグランのサンプル調査)。当リポジトリの旧マグナ19本で観測された Exスキル(第2スキル枠):

- 方陣背水(例: 嵐竜方陣・背水 `skill_id` 287、黒霧方陣・背水 318)
- 方陣見切 / 方陣技巧(霧氷の見切 149、紅蓮の技巧 86 ※後者は通常スキル)
- 他属性の通常攻刃(光の攻刃 5、霧氷の攻刃 26)
- 他属性の通常守護(地裂の守護 33、紅蓮の守護 31)
- 他属性の通常背水(乱気の背水 133)

一般に挙げられる候補: 方陣HP / 方陣三手(連撃) / 方陣背水 / 方陣渾身 / 無属性(通常)攻刃 / 通常HP / 各種ダメージ上限UP など。完全なプールと各効果量は**要検証**。

出典: [GameWith EXスキル記事](https://xn--bck3aza1a2if6kra4ee0hf.gamewith.jp/article/show/245175) / [神ゲー攻略](https://kamigame.jp/%E3%82%B0%E3%83%A9%E3%83%96%E3%83%AB/%E3%82%A2%E3%83%BC%E3%82%AB%E3%83%AB%E3%83%A0%E3%81%AE%E8%BB%A2%E4%B8%96/EX%E3%82%B9%E3%82%AD%E3%83%AB.html) / [tkグランのグラブル攻略日記(サンプル調査)](https://tkgranblue.com/archives/13539)
