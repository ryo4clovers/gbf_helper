...
<!-- skill1〜skill4。実機レスポンスの各 skillN に name / skill_id / comment(効果文)がある。
     ...
     マグナ(旧)/アンセスタル(六竜)/プライマル/オールドプライマルは、skill2 以降がドロップ時に
     ランダム抽選される「Exスキル」のことがある。**Exスキルは個体差のため各武器ファイルには書かない**
     (武器固有スキルのみ記載)。付与シリーズと抽選パターンは README.md の「Exスキル」節にまとめる。
     旧マグナ等で Exスキルが付く武器は、武器スキルの後に短い「## Exスキル」節を置き README へ誘導する。 -->
