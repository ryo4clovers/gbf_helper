...
- 系統/カテゴリ: (例: 攻刃〈通常攻刃〉/ 方陣攻刃〈オメガ〉/ 神威〈EX〉/ 背水 / 渾身 / 克己 / 守護 / 治癒 / 特殊 …)
...
- スキルレベル: (上げ方 / 上限。`master.max_weapon_skill_level`)
- 超越(あれば): (実機 `can_release_transcendence` / `transcendence_*`。Lv100→200 の強化内容・段階)
