...
| ジョブLvアップボーナス(Lv20到達時点の合計) | 攻撃力+750、アビリティダメージ+10%(内訳は下記「ジョブLvアップボーナス(レベル別)」参照) |
| コンプリートボーナス | (要確認) |
...
### アビリティ2: アローレインII(Lv5で習得)
![アローレインII](https://prd-game-a-granbluefantasy.akamaized.net/assets/img/sp/ui/icon/ability/m/59_1.png)

- 効果(初期): 敵全体に自属性ダメージ/攻撃DOWN(小)
- 使用間隔: 5ターン
- 出典: 実機(グランブルーファンタジー公式サイト、ジョブLv詳細レスポンス)

### アビリティ3: ハードライン(Lv15で習得)
![ハードライン](https://prd-game-a-granbluefantasy.akamaized.net/assets/img/sp/ui/icon/ability/m/42_1.png)
...
| Lv | 内容 |
| --- | --- |
| 1 | 攻撃力+150、アビリティダメージ+2% |
| 5 | 攻撃力+150、アビリティダメージ+2% |
| 10 | 攻撃力+150、アビリティダメージ+2% |
| 15 | 攻撃力+150、アビリティダメージ+2% |
| 20 | 攻撃力+150、アビリティダメージ+2% |

## マスターレベル強化

- ジョブ固有のマスターレベル強化(Lv20到達時): 弱体成功率+2%
...
- 英語名(`Marksman`)は一般的な訳語からの暫定表記、正式名称は要検証。
