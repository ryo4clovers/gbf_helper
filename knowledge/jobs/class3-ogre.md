...
| ジョブLvアップボーナス | 攻撃力:2000、HP:200、ダブルアタック確率:20% |
| コンプリートボーナス | (要確認) |
...
- 効果: 敵対心UP/カウンターが発動しているとき反撃回数UP(2回)
- 使用間隔: 7ターン
- 出典: 実機(グランブルーファンタジー公式サイト、ジョブ画面API)
...
- 英語名(`Ogre`)は一般的な訳語からの暫定表記、正式名称は要確認。
