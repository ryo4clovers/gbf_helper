...
うち68ジョブ(class1-knight、ex1-assassin、origin1-fighter-origin、および2026-09-06に処理した65ジョブ: class1残り6・class2全10・class3全11・class4全18・class5全9・ex1残り9・origin1残り2)は、より詳細な「ジョブLv詳細」レスポンス(基本/リミットアビリティの区別、レベル別ボーナス、アビリティアイコン等を含む)を元に更新済み。ClassI/II/III/V/エクストラ/オリジンは全面的に作り直し。**ClassIV全18ジョブのみ、元々GameWith記事ベースの詳細な記述(概要・極致の証・マスターレベル30強化等)を持っていたためそれらは温存し、アビリティアイコンとレベル別ボーナス内訳をマージ追記する方式**で更新(全面作り直しではない)。残り9ジョブ(エクストラII全9)は旧来の`job_equipped`ベースの簡易形式のまま(アイコン画像やリミットアビリティの区別なし)。
...
| ジョブ名 | job_id | 得意武器 | メイン評価 | 取得優先度 | ステータス |
| --- | --- | --- | --- | --- | --- |
| ウォーリア | 100101 | 剣/斧 | - | - | 下書き |
| フォートレス | 110101 | 剣/槍 | - | - | 下書き |
| クレリック | 120101 | 杖/槍 | - | - | 下書き |
| ソーサラー | 130101 | 杖/短剣 | - | - | 下書き |
| レイダー | 140101 | 短剣/銃 | - | - | 下書き |
| アルカナソード | 150101 | 剣/短剣 | - | - | 下書き |
| クンフー | 160101 | 格闘/格闘 | - | - | 下書き |
| マークスマン | 170101 | 弓/銃 | - | - | 下書き |
| ミンストレル | 180101 | 楽器/短剣 | - | - | 下書き |
| ドラグーン | 190101 | 槍/斧 | - | - | 下書き |

### ClassIII(11ジョブ)

| ジョブ名 | job_id | 得意武器 | メイン評価 | 取得優先度 | ステータス |
| --- | --- | --- | --- | --- | --- |
| グラディエーター | 300201 | 剣/刀 | 5 | 5 | 下書き |
| ダークフェンサー | 150201 | 剣/短剣 | 5 | 5 | 下書き |
| スーパースター | 180201 | 楽器/短剣 | 5 | 3 | 下書き |
| ホーリーセイバー | 110201 | 剣/槍 | 4 | 4 | 下書き |
| ビショップ | 120201 | 杖/槍 | 4 | 4 | 下書き |
| ホークアイ | 140201 | 短剣/銃 | 4 | 3 | 下書き |
| ウェポンマスター | 100201 | 剣/斧 | 3 | 3 | 下書き |
| サイドワインダー | 170201 | 弓/銃 | 2 | 4 | 下書き |
| ハーミット | 130201 | 杖/短剣 | 2 | 3 | 下書き |
| ヴァルキュリア | 190201 | 槍/斧 | 2 | 3 | 下書き |
| オーガ | 160201 | 格闘/格闘 | 2 | 4 | 下書き |

### ClassIV(18ジョブ)

| ジョブ名 | job_id | 得意武器 | メイン評価 | 取得優先度 | ステータス |
| --- | --- | --- | --- | --- | --- |
| シールドスウォーン | 470301 | 斧/銃 | 5 | 5 | 下書き |
| ヤマト | 460301 | 剣/刀 | 5 | 5 | 下書き |
| レリックバスター | 450301 | 剣/銃 | 5 | 5 | 下書き |
| ロビンフッド | 440301 | 弓/弓 | 5 | 5 | 下書き |
| モンク | 430301 | 格闘/杖 | 4 | 5 | 下書き |
| ランバージャック | 410301 | 斧/楽器 | 5 | 5 | 下書き |
| レスラー | 160301 | 格闘/格闘 | 5 | 5 | 下書き |
| ハウンドドッグ | 170301 | 弓/銃 | 5 | 5 | 下書き |
| クリュサオル | 300301 | 剣/刀 | 5 | 4 | 下書き |
| キャバルリー | 420301 | 槍/銃 | 4 | 3 | 下書き |
| ウォーロック | 130301 | 杖/短剣 | 4 | 4 | 下書き |
| カオスルーダー | 150301 | 剣/短剣 | 4 | 4 | 下書き |
| スパルタ | 110301 | 剣/槍 | 5 | 4 | 下書き |
| 義賊 | 140301 | 短剣/銃 | 4 | 3 | 下書き |
| アプサラス | 190301 | 槍/斧 | 5 | 4 | 下書き |
| セージ | 120301 | 杖/槍 | 3 | 5 | 下書き |
| エリュシオン | 180301 | 楽器/短剣 | 3 | 5 | 下書き |
| ベルセルク | 100301 | 剣/斧 | 5 | 5 | 下書き |

### ClassV(9ジョブ)

| ジョブ名 | job_id | 得意武器 | メイン評価 | 取得優先度 | ステータス |
| --- | --- | --- | --- | --- | --- |
| マリアッチ | 180401 | 楽器/楽器 | 4 | 5 | 下書き |
| ブギーマン | 170401 | 弓/銃 | 5 | 5 | 下書き |
| スマヒヒト | 160401 | 格闘/格闘 | 5 | 5 | 下書き |
| 陰陽師 | 150401 | 短剣/刀 | 5 | 5 | 下書き |
| キング | 140401 | 短剣/銃 | 5 | 5 | 下書き |
| マナダイバー | 130401 | 杖/短剣 | 5 | 5 | 下書き |
| パナケイア | 120401 | 杖/槍 | 4 | 4 | 下書き |
| ヴァイキング | 100401 | 剣/斧 | 5 | 5 | 下書き |
| パラディン | 110401 | 剣/槍 | 5 | 5 | 下書き |

### エクストラ(10ジョブ)

| ジョブ名 | job_id | 得意武器 | メイン評価 | 取得優先度 | ステータス |
| --- | --- | --- | --- | --- | --- |
| メカニック | 290201 | 銃/銃 | 4 | 3 | 下書き |
| ダンサー | 280201 | 短剣/短剣 | 4 | 3 | 下書き |
| 忍者 | 210201 | 刀/格闘 | 3 | 3 | 下書き |
| 賢者 | 250201 | 杖/杖 | 3 | 3 | 下書き |
| ドラムマスター | 270201 | 楽器/楽器 | 3 | 4 | 下書き |
| 剣聖 | 230201 | 剣/刀 | 4 | 3 | 下書き |
| ガンスリンガー | 240201 | 銃/銃 | 3 | 5 | 下書き |
| アサシン | 260201 | 短剣/短剣 | 3 | 4 | 下書き |
| 侍 | 220201 | 刀/弓 | 2 | 4 | 下書き |
| アルケミスト | 200201 | 短剣/銃 | 2 | 3 | 下書き |

### エクストラII(9ジョブ)

| ジョブ名 | job_id | 得意武器 | メイン評価 | 取得優先度 | ステータス |
| --- | --- | --- | --- | --- | --- |
| マスカレード | 280301 | 短剣/短剣 | 3 | 4 | 下書き |
| ライジングフォース | 270301 | 楽器/楽器 | 4 | 3 | 下書き |
| トーメンター | 260301 | 短剣/短剣 | 5 | 3 | 下書き |
| ソルジャー | 240301 | 銃/銃 | 5 | 2 | 下書き |
| 剣豪 | 220301 | 刀/弓 | 5 | 4 | 下書き |
| 魔法戦士 | 210301 | 刀/格闘 | 4 | 2 | 下書き |
| ザ・グローリー | 230301 | 剣/刀 | 5 | 4 | 下書き |
| 黒猫道士 | 250301 | 杖/杖 | 5 | 2 | 下書き |
| ドクター | 200301 | 短剣/銃 | 3 | 2 | 下書き |

### オリジン(3ジョブ)

| ジョブ名 | job_id | 得意武器 | メイン評価 | 取得優先度 | ステータス |
| --- | --- | --- | --- | --- | --- |
| ファイター | 100501 | 剣/斧 | 5 | 5 | 下書き |
| ランサー | 190501 | 槍/斧 | 5 | 5 | 下書き |
| ウィザード | 130501 | 杖/楽器 | - | - | 下書き |
