---
id: "wind-ssr-quetzalcoatl-normal"
name_jp: "ケツァルカトル"
...
source: "GameWith SSR召喚石一覧 (https://xn--bck3aza1a2if6kra4ee0hf.gamewith.jp/article/show/136372) と gbf.wiki (https://gbf.wiki/Quetzalcoatl) の両方で確認(取得日: 2026-08-20)。ATK/HPともに一致。"
---
...
| レベル | HP | ATK |
| --- | --- | --- |
| Lv100(3★)・最終上限解放 | 755 | 1895 |

## 召喚効果

### 初期『セーアカトル』

- 効果: 敵全体に風属性ダメージ(特大) / 味方全の防御力UP(大)
- 使用間隔: 9ターン
- 再召喚: 可
- 出典: GameWith(個別ページ)
