...
| --- | --- | --- |
| Lv100(3★) | 664 | 1765 |
| Lv150(4★・最終上限解放) | 948 | 2480 |

## 召喚効果

### 初期

- 効果: 敵全体に火属性4倍ダメージ / 2番目までに配置された火属性キャラがターン進行時に攻撃行動を2回行う
- 初回召喚: 5ターン後
- 使用間隔: 9ターン
- 再召喚: 可
- 出典: GameWith(個別ページ)
...
- 効果: 敵全体に火属性4倍ダメージ / 3番目までに配置された火属性キャラがターン進行時に攻撃行動を2回行う
- 初回召喚: 3ターン後
- 使用間隔: 9ターン
- 再召喚: 可
- 出典: GameWith(個別ページ)
...
- 効果: 敵全体に火属性5倍ダメージ / 3番目までに配置された火属性キャラがターン進行時に攻撃行動を2回行う
- 初回召喚: 3ターン後
- 使用間隔: 9ターン
- 再召喚: 可
- 出典: GameWith(個別ページ)
...
- 効果: (3凸)火属性キャラの連続攻撃確率UP(ターン経過で効果UP) / (4凸)火属性キャラの連続攻撃確率UP(ターン経過で効果UP)
- 出典: GameWith
