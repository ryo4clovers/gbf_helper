---
id: "light-ssr-heavenly-thunder-blade-wrapped-in-lightning-normal"
name_jp: "雷光を纏いし天雷剣"
name_en: "Heavenly Thunder Blade Wrapped in Lightning"
rarity: SSR
element: "光"
obtain: "イベント報酬"
status: 下書き
...
| レベル | HP | ATK |
| --- | --- | --- |
| Lv100(3★)・最終上限解放 | 607 | 1287 |

## 召喚効果

### 初期『エレクトロンブレード』

- 効果: 敵全体に光属性ダメージ(特大) / 光属性キャラのクリティカル確率UP(倍率30%/発動率約60%)×2ターン / 召喚効果 (3凸解放) / 敵全体に光属性ダメージ(特大) / 光属性キャラのクリティカル確率UP(倍率30%/発動率約60%)×3ターン
- 使用間隔: 9ターン
- 再召喚: 可
- 出典: GameWith(個別ページ)
...
- 効果: 光属性攻撃力が40%UP/光属性攻撃時にクリティカル確率UP / (3凸)光属性攻撃力UPが50%に強化
- 出典: GameWith
