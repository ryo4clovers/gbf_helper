...
export const JOB_COMPLETION_BONUS_DEFINITIONS = [
  ...
  bonus("ランバージャック", "メイン武器が斧のときメイン武器攻撃力+3%", [effect("mainWeaponAttack", "メイン武器攻撃力", 3, "main-axe")]),
  bonus("キャバルリー", "メイン武器が槍のときメイン武器攻撃力+3%", [effect("mainWeaponAttack", "メイン武器攻撃力", 3, "main-spear")]),
  bonus("モンク", "アビリティダメージ上限+3%", [effect("abilityDamageCap", "アビリティダメージ上限", 3)]),
  bonus("ロビンフッド", "メイン武器が弓のときメイン武器攻撃力+3%", [effect("mainWeaponAttack", "メイン武器攻撃力", 3, "main-bow")]),
  bonus("レリックバスター", "メイン武器が剣のときメイン武器攻撃力+3%", [effect("mainWeaponAttack", "メイン武器攻撃力", 3, "main-sword")]),
  bonus("ヤマト", "攻撃力+1%、アビリティダメージ上限+2%", [effect("attack", "攻撃力", 1), effect("abilityDamageCap", "アビリティダメージ上限", 2)]),
  bonus("シールドスウォーン", "メイン武器が斧のときメイン武器攻撃力+3%", [effect("mainWeaponAttack", "メイン武器攻撃力", 3, "main-axe")]),
  ...
  bonus("ブギーマン", "メイン武器が銃のときメイン武器攻撃力+3%", [effect("mainWeaponAttack", "メイン武器攻撃力", 3, "main-gun")]),
  ...
  bonus("魔法戦士", "メイン武器が格闘のときメイン武器攻撃力+3%", [effect("mainWeaponAttack", "メイン武器攻撃力", 3, "main-melee")]),
  bonus("剣豪", "メイン武器が刀のときメイン武器攻撃力+3%", [effect("mainWeaponAttack", "メイン武器攻撃力", 3, "main-katana")]),
  bonus("ザ・グローリー", "メイン武器が剣のときメイン武器攻撃力+3%", [effect("mainWeaponAttack", "メイン武器攻撃力", 3, "main-sword")]),
  bonus("ソルジャー", "メイン武器が銃のときメイン武器攻撃力+3%", [effect("mainWeaponAttack", "メイン武器攻撃力", 3, "main-gun")]),
  bonus("黒猫道士", "メイン武器が杖のときメイン武器攻撃力+3%", [effect("mainWeaponAttack", "メイン武器攻撃力", 3, "main-staff")]),
  bonus("トーメンター", "メイン武器が短剣のときメイン武器攻撃力+3%", [effect("mainWeaponAttack", "メイン武器攻撃力", 3, "main-dagger")]),
  bonus("ライジングフォース", "メイン武器が楽器のときメイン武器攻撃力+3%", [effect("mainWeaponAttack", "メイン武器攻撃力", 3, "main-harp")]),
