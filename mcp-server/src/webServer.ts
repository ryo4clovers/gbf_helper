...
const staticFiles: Record<string, { file: string; contentType: string }> = {
  ...
  "/calculator-webmcp.js": { file: "calculator-webmcp.js", contentType: "text/javascript; charset=utf-8" },
  "/calculator-default-deck.js": { file: "calculator-default-deck.js", contentType: "text/javascript; charset=utf-8" },
  ...
  "/catalog-picker-filter.js": { file: "catalog-picker-filter.js", contentType: "text/javascript; charset=utf-8" },
...
const server = createServer(async (request, response) => {
  try {
    ...
    if (request.method === "GET" && url.pathname === "/api/catalog/characters") {
      json(response, 200, createSelectableCharacterCatalog());
      return;
    }
    ...
    if (request.method === "GET" && url.pathname === "/api/catalog/job-fallback-weapons") {
      json(response, 200, createJobFallbackWeaponCatalogView());
      return;
    }
