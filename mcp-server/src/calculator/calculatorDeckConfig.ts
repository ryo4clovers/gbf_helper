...
const protagonistSchema = z
  .object({
    ...
    hp2LimitBonusLevel: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    ...
    criticalRateLimitBonusLevel: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    criticalRateLimitBonus2Level: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    criticalRateLimitBonus3Level: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    ...
    proficiency2AttackLimitBonus2Level: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    proficiency1AttackLimitBonus3Level: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    proficiency2AttackLimitBonus3Level: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    proficiencyBothAttackLimitBonusLevel: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    proficiencyBothAttackLimitBonus2Level: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    ...
    waterAttackLimitBonusLevel: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    waterAttackLimitBonus2Level: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    waterAttackLimitBonus3Level: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    earthAttackLimitBonusLevel: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    earthAttackLimitBonus2Level: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    earthAttackLimitBonus3Level: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    windAttackLimitBonusLevel: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    windAttackLimitBonus2Level: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    windAttackLimitBonus3Level: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    lightAttackLimitBonusLevel: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    lightAttackLimitBonus2Level: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    lightAttackLimitBonus3Level: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    darkAttackLimitBonusLevel: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    darkAttackLimitBonus2Level: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
    darkAttackLimitBonus3Level: nonNegativeIntegerSchema.refine((value) => value <= 3).optional(),
