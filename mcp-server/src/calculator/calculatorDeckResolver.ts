...
export function resolveCalculatorDeckConfig(
  ...
  const displayedStats = canDeriveDisplayedStats
    ? calculateProtagonistDisplayedStats({
        ...
        proficiency2AttackLimitBonus2Level: config.protagonist.proficiency2AttackLimitBonus2Level,
        proficiency1AttackLimitBonus3Level: config.protagonist.proficiency1AttackLimitBonus3Level,
        proficiency2AttackLimitBonus3Level: config.protagonist.proficiency2AttackLimitBonus3Level,
